...
## 安装依赖
`cnpm install @babel/core @babel/parser @babel/traverse @babel/preset-env --save-dev`
...
## 运行
```shell
node bundler # 可以看到文件夹里多了 bundle.js 文件
node bundle # 运行打包后的文件
```

## 参考
- [理解webpack原理，手写一个100行的webpack](https://zhuanlan.zhihu.com/p/58151131?utm_source=wechat_session&utm_medium=social&utm_oi=726559320958853120)